...
Start-Process -FilePath $cli -ArgumentList "probe-map --map `"C:\Games\23 Race\23-Race-Legion\map.w3x`" --warcraft `"F:\Games\Warcraft III`" --click-after 60 --wait 300 --bridge-script 140:create_ai:2 --probe-log 23Race_probe_log.pld --keep-open" -NoNewWindow
